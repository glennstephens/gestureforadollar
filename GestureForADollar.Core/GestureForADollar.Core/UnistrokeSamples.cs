...
{
	public static class UnistrokeSamples
	{
		public static Unistroke Triangle = new Unistroke("Triangle",
														 new List<Point>() {
			new Point(137, 139),
			new Point(135, 141),
			new Point(133, 144),
		...
		public static Unistroke X = new Unistroke("X", new List<Point>()
		{
			new Point(87,142),
			new Point(89,145),
			new Point(91,148),
			...
			new Point(135,145),new Point(131,152),new Point(124,163),new Point(116,177),new Point(108,191),new Point(100,206),new Point(94,217),new Point(91,222),new Point(89,225),new Point(87,226),new Point(87,224)
		});

		public static Unistroke Rectangle = new Unistroke("Rectangle",
														 new List<Point>()
														 {
		...
		public static Unistroke Circle = new Unistroke("Circle", new List<Point>()
		{
		...
		public static Unistroke Check = new Unistroke("Check", new List<Point>()
		{
		...
		public static Unistroke Caret = new Unistroke("Caret", new List<Point>()
		{
		...
		public static Unistroke ZigZag = new Unistroke("ZigZag", new List<Point>()
		{
			new Point(307,216),new Point(333,186),new Point(356,215),new Point(375,186),new Point(399,216),new Point(418,186)
		});

		public static Unistroke Arrow = new Unistroke("Arrow", new List<Point>()
		{
		...
		public static Unistroke LeftSquareBracket = new Unistroke("Left Square Bracket", new List<Point>()
		{
		...
		public static Unistroke RightSquareBracket = new Unistroke("Right Square Bracket", new List<Point>()
		{
		...
		public static Unistroke V = new Unistroke("V", new List<Point>()
		{
		...
		public static Unistroke Delete = new Unistroke("Delete", new List<Point>()
		{
		...
		public static Unistroke LeftCurlyBrace = new Unistroke("Left Curly Brace", new List<Point>()
		{
		...
		public static Unistroke RightCurlyBrace = new Unistroke("Right Curly Brace", new List<Point>()
		{
		...
		public static Unistroke Star = new Unistroke("Star", new List<Point>()
		{
		...
		public static Unistroke Pigtail = new Unistroke("Pigtail", new List<Point>()
		{
